...
import { DayEditor } from '../components/doctors/DayEditor';
import { Slot, DaySchedule, WeekSchedule } from '../types/schedule';
    ...
    <div className="min-h-screen bg-slate-50 p-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          <div>
            <label className="block text-xs text-slate-600 mb-1">Doctor ID</label>
            <select
              value={doctorId}
