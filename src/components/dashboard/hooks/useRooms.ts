...
import { VmFloorRoom } from '../../../api/rooms';
import { MOCK_DOCTOR_LIST } from '../../../data/mockData';
import { dateKey, seededPercent } from '../../../pages/dashboardShared';

export type DoctorInfo = { id: string; name: string; department?: string };
